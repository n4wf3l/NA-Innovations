                ...
                <div className="animate-fade-in">
                    {pendingProjects.length === 0 ? (
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-16 text-center">
                            ...
                            <p className="text-sm font-medium text-gray-500">No pending projects</p>
                            <p className="text-xs text-gray-400 mt-1">All projects are currently assigned. Check back later.</p>
                        </div>
                    ) : (
            ...
            {activeTab === 'my' && (
                <div className="animate-fade-in">
                    {myProjects.length === 0 ? (
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-16 text-center">
                            <div className="w-14 h-14 rounded-full bg-gray-50 flex items-center justify-center mx-auto mb-4">
                                <svg className="w-7 h-7 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            </div>
                            <p className="text-sm font-medium text-gray-500">No projects yet</p>
                            <p className="text-xs text-gray-400 mt-1">Claim a pending project to get started.</p>
                            <button
                                onClick={() => switchTab('pending')}
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-gray-50">
                                        ...
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider hidden lg:table-cell">Started</th>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col">
            ...
            <div className="space-y-2 flex-1">
                ...
                {project.langage_programmation && (
                    <div className="flex items-center text-xs text-gray-500">
                        <svg className="w-3.5 h-3.5 mr-1.5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" /></svg>
                        {project.langage_programmation}
                    </div>
                )}
                {partnerName && (
