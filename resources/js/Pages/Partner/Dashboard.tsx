    ...
    return (
        <div ref={setNodeRef} style={style} className={`group/tile transition-shadow duration-200 ${isDragging ? 'shadow-2xl ring-2 ring-rose-500/30 rounded-2xl' : ''}`}>
            ...
            <div className="flex items-center justify-between mb-2 px-2 py-1.5 opacity-60 hover:opacity-100 group-hover/tile:opacity-100 transition-opacity">
                <div {...attributes} {...listeners} className="cursor-grab active:cursor-grabbing flex items-center gap-2 text-gray-400 hover:text-rose-500 dark:hover:text-rose-400 p-1 rounded-lg transition-colors" title={t('Glisser pour réorganiser')}>
                ...
                <div className="flex items-center gap-1">
                    <button onClick={onToggleCollapse} className="p-1.5 text-gray-400 hover:text-rose-500 dark:hover:text-rose-400 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors" title={collapsed ? t('Ouvrir') : t('Fermer')}>
                    ...
                    <button onClick={onToggleHide} className="p-1.5 text-gray-400 hover:text-red-500 rounded-lg hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors" title={t('Masquer')}>
