...
interface Props {
    ...
    stats: { total: number; with_follow_up: number; overdue: number; submitted: number };
}
...
export default function ProspectsIndex({ kanbanProspects: initialKanban, stats }: Props) {
        ...
        <PartnerLayout title={t('Prospects')}>
            ...
            <KanbanBoard<Prospect>
                ...
                renderCard={(prospect, isDragging) => (
                    <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 hover:shadow-md transition-shadow group ${isOverdue(prospect) ? 'ring-2 ring-red-400/50' : ''}`}>
                        <div className="flex items-start justify-between mb-1">
                            ...
                            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <button onClick={e => { e.stopPropagation(); setDeleteConfirm(prospect.id); }} className="w-6 h-6 rounded-md bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 hover:text-red-500 transition-colors">
