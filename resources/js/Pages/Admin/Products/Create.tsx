...
export default function ProductCreate({ projects }: Props) {
    ...
    return (
        <AdminLayout title={t('Create Product')} header={t('Create Product')}>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">{t('Create Product')}</h1>
                </div>
