...
export default function PageEdit({ page }: Props) {
    ...
    return (
        <AdminLayout title={t("Edit Page")} header={t("Edit Page")}>
            <Head title={t("Edit Page")} />

            <div className="mb-6 flex items-center justify-between">
                <Link href="/admin/pages" className="text-sm text-gray-500 hover:text-gray-700">&larr; {t("Back to Pages")}</Link>
            ...
            <form onSubmit={submit} className="space-y-6 max-w-4xl">
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">{t("Page Details")}</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t("Sort Order")}</label>
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 mb-1">{t("Icon (SVG path)")}</label>
                ...
                {/* Content */}
                <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                    <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">{t("Content (HTML)")}</h3>
                    <textarea
                        value={data.content}
                ...
                <div className="flex items-center justify-end gap-3">
                    <Link href="/admin/pages" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">{t('Cancel')}</Link>
