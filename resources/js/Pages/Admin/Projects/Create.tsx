        ...
        <AdminLayout title={t("New Project")} header={t("New Project")}>
            ...
            <form onSubmit={submit} className="space-y-6 max-w-4xl">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
                    ...
                    {usePage<PageProps>().props.auth.user?.github_username ? (
                        <div className="space-y-4">
                            <p className="text-xs text-gray-400 dark:text-gray-500">{t('Connected as')} <span className="font-semibold text-gray-700 dark:text-gray-300">@{usePage<PageProps>().props.auth.user.github_username}</span></p>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t("Repository")}</label>
