        ...
        <AdminLayout title={t("New Recurring Service")} header={t("New Recurring Service")}>
            ...
            <form onSubmit={submit} className="space-y-6 max-w-4xl">
                ...
                <div className="flex items-center justify-end gap-3">
                    <Link href="/admin/services" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">{t('Cancel')}</Link>
