                            ...
                            <div className="grid grid-cols-12 gap-3 items-end">
                                ...
                                <div className="col-span-3 sm:col-span-1">
                                    ...
                                    <input type="number" value={item.quantity} onChange={e => updateItem(i, 'quantity', parseFloat(e.target.value) || 0)}
                                        className={`w-full bg-gray-50 dark:bg-gray-700/50 border-0 rounded-lg px-3 py-2.5 text-sm text-gray-900 dark:text-white focus:bg-white dark:focus:bg-gray-700 focus:ring-2 focus:ring-emerald-400 ${errorRing(`items.${i}.quantity`)}`} min="0.01" step="0.01" />
