...
export default function LeadCreate({ partners, projectTypes }: Props) {
    ...
    return (
        <AdminLayout title={t("New Lead")} header={t("New Lead")}>
            <Head title={t("New Lead")} />
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    <Link href="/admin/leads" className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">{t('Cancel')}</Link>
