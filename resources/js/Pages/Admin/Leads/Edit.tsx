...
export default function LeadEdit({ lead, partners }: Props) {
    ...
    return (
        <AdminLayout title="Edit Lead" header="Edit Lead">
            <Head title="Edit Lead" />

            <div className="mb-6">
                <Link href={`/admin/leads/${lead.id}`} className="text-sm text-gray-500 hover:text-gray-700">&larr; Back to Lead</Link>
            </div>
            ...
            <form onSubmit={submit} className="space-y-6 max-w-4xl">
                ...
                <div className="flex items-center justify-end gap-3">
                    <Link href={`/admin/leads/${lead.id}`} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</Link>
