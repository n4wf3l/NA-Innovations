...
export default function LeadShow({ lead, timeline }: Props) {
    ...
    return (
        <AdminLayout title={`${lead.first_name} ${lead.last_name}`} header="Lead Details">
            ...
            <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <Link href={`/admin/leads/${lead.id}/edit`} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50">Edit</Link>
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    {lead.notes && (
                        <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm">
                            <h4 className="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-3">Notes</h4>
                    ...
                    {lead.lost_reason && (
                        <div className="bg-red-50 rounded-xl border border-red-200 p-5">
                            <h4 className="text-sm font-semibold text-red-700 uppercase tracking-wider mb-3">Lost Reason</h4>
