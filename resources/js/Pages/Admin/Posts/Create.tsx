...
export default function PostCreate({ categories }: Props) {
    ...
    // All unique categories (preset + existing from DB)
            ...
            <form onSubmit={submit}>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
                            ...
                            <div className="mt-3 flex items-center gap-2">
                                ...
                                <input
                                    type="text"
                                    value={data.slug}
                                    onChange={e => { setData('slug', e.target.value); setSlugEdited(true); }}
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
                            ...
                            {preview ? (
                                <div className="relative mb-3">
                                    <img src={preview} alt="Preview" className="w-full aspect-video object-cover rounded-xl border border-gray-200 dark:border-gray-600" />
                                    <button
                                        type="button"
                                ...
                                <label className="flex flex-col items-center justify-center w-full aspect-video border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl cursor-pointer hover:border-teal-400 hover:bg-teal-50/5 transition-colors mb-3">
                                    ...
                                    <span className="text-xs text-gray-400">{t("Click or drag to upload")}</span>
                ...
                <div className="flex items-center justify-end gap-3 mt-8 pb-8">
                    ...
                    >
                        ...
                        {data.status === 'published' ? t('Publish') : t('Save as draft')}
                    </button>
                </div>
            </form>
        </AdminLayout>
