                            ...
                            {services.map((service) => (
                                <div key={service.id} className="group p-4 md:p-8 bg-gray-50 dark:bg-gray-800/50 rounded-xl md:rounded-2xl border border-gray-100 dark:border-gray-700 md:hover:border-teal-300 md:hover:shadow-lg md:hover:-translate-y-1 transition-all duration-300 flex md:block items-center gap-3 md:gap-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="text-base md:text-xl font-bold text-gray-900 dark:text-white mb-0.5 md:mb-3">{t(service.title)}</h3>
                                        <p className="text-gray-600 dark:text-gray-300 text-xs md:text-sm leading-snug md:leading-relaxed line-clamp-2 md:line-clamp-none">{t(service.description)}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
