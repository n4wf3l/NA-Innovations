...
@section('content')
    ...
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('Edit Lead') }}</h1>
        <p class="text-sm text-gray-500 mt-1">{{ __("Update this prospect's information and status.") }}</p>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="referral_partner_id"
                            ...
                            @foreach($partners as $partner)
                                <option value="{{ $partner->id }}" {{ old('referral_partner_id', $lead->referral_partner_id) == $partner->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="service_interest"
                               value="{{ old('service_interest', $lead->service_interest) }}"
                    ...
                    <div>
                        ...
                        <input type="number"
                               ...
                               id="estimated_budget"
                               value="{{ old('estimated_budget', $lead->estimated_budget) }}"
                               step="0.01"
                               min="0"
                               placeholder="0.00"
                               class="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-teal-300 focus:ring-teal-300">
            ...
            <div class="mt-6">
                ...
                <textarea name="notes"
                          ...
                          rows="4"
                          class="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-teal-300 focus:ring-teal-300"
                          placeholder="{{ __('Any additional notes about this lead...') }}">{{ old('notes', $lead->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
